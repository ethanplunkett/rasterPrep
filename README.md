...
Nov 17, 2022 (v.0.1.12) warpToReference now has bigtiff argument to request 
BigTIFF formated geoTIFF. BigTIFF is an extension of TIFF that allows files 
...
Oct 8, 2022 (v.0.1.11) added compression argument to warpToReference which allows specifying LZW or DEFLATE compression
...
>>>>>>> 7c52224 (Added compression and bigtiff arguments to warpToReference)
