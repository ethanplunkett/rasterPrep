...
#' boundary.
#'
#' @param x a vector of coordinates (either x or y component) to be snapped to a cell boundary
#' @param cellsize the cellsize of the grid being snapped.
#' @param up if TRUE then the number is snapped up to the nearest cell boundary if FALSE
#'  it is snapped down.
