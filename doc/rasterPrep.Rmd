...
# a temporary directory I'm defining complete paths here.  Often it's easier
# to set a working directory then use file names when calling the functions.
...
the original projection and cell alignment preserved.  It is in the USA Contiguous Albers Equal Area Conic Projection([ESRI:102003](https://epsg.io/102003)).  EPSG:5070
