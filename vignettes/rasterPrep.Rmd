...
inot a set of coinciding TIFF files.
...
You could also usethe **sf** package to read in the vector data, reproject, and
...
landcover where we might use greens for natural uplands, blues for water, greys
and blacks for roads, etc. 

There are a couple of limitations to the color tables suppported here.
